...
/**
 * Produit est la classe qui represente un produit qui agrege famille, ssfam,
 * marque
 * 
 * @version 1.0
 * @date 29 mars 2019
...
public class Produit {
	...
	public String toString() {
		return (this.idProduit + " - " + this.intituleProduit + " - " + this.fam.getIntitule() + " - "
				+ this.sousFam.getIntitule_ssFamille() + " - " + this.marque.getNomMarque());
	}
}
