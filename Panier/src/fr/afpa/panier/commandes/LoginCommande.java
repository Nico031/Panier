...
/**
 * LoginCommande est la classe qui va recup la saisie dans un objet client puis
 * va renvoyer vers les pages correspondantes selon la verification de la saisie
 * 
 * @version 1.0
 * @date 29 mars 2019
 * @author nico
