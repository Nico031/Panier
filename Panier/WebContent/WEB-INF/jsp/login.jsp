...
<body>
	...
	<form method='POST' action='frontControler?cmd=Login'>
		...
		<label for='ident'>Identifiant : </label> <input name='ident'
			type='text' id='ident' required autofocus /><br>
		<br> <label for='mdp'>Mot de passe : </label> <input name='pass'
			type='password' id='mdp' required /><br>
		<br>
		<%-- type='password' =>masque le mdp qd l'utilisateur le tape --%>
